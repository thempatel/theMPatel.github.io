...
const story: string[] = [
  ...
  'After 4 years of many sleepless nights, many extracurriculars (including a part-time job as a',
  'computer tech and some late night EMT shifts) I faced rejection from all 26 medical schools that I',
  'had applied to. Ouch.',
  '',
  ...
  'would block off a few days during the week to make ends meet at the CDC and use the rest of the week',
  'for shifts at the coffee shop.',
  '',
  'During those 20 hours at the CDC, I tried to be as much of a go-getter as possible. There was some',
  "stipulation during the interview that I'd get to work with computers in addition to collecting stool",
  'which turned out, at least in the early stages, to not be the case. Although it had been a step up',
  'from the coffee shop in terms of prestige, I still had not achieved the impact I was searching for.',
  ...
  'I was promptly signed up for another 20 hours to come work for her part-time and consequently left my job',
  'as a barista.',
  '',
