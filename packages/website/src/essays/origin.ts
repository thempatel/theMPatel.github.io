...
export const OriginStory: string[] = [
  ...
  'schools in the following cycle and the 20 hours there would pay double what I was making doing 40 at',
  ...
  'what I really wanted to do with my life. I also knew that I wanted to working as a software engineer',
  'in industry and the CDC wasn\'t going to help me meet that long term goal, so I left.',
  '',
